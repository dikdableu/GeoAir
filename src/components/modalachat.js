...
export default class Modalachat extends Component {
  ...
  render() {
    ...
    return (
    <ScrollView data-layer="98e6de10-7b25-4a17-82ed-1dec0fec39d6" style={styles.modalachat}>
        <View data-layer="6ed0e6cb-78ac-4c51-91d6-141259761f67" style={styles.modalachat_bg}>
            <View data-layer="b5b3f336-be55-4d3e-823d-c35618760d2f" style={styles.modalachat_bg_bgBleue4641984}>
                <ReactImage data-layer="05ac74f7-8740-4f67-9b4f-0c78da81257c" source={require('./assets/mask5a3bc501.png')} style={styles.modalachat_bg_bgBleue4641984_mask5a3bc501} />
                <ReactImage data-layer="85c250c2-bfac-43b3-866b-0ca73b0a66ae" source={require('./assets/bgBleu.png')} style={styles.modalachat_bg_bgBleue4641984_bgBleu} />
            </View>
        </View>
        <View data-layer="18428b44-2bbd-4118-bf5d-e0e1496af322" style={styles.modalachat_modal}>
            ...
            <View data-layer="d2c47017-7064-4045-92e8-4a59d1a869e7" style={styles.modalachat_modal_restaurerachats}>
                ...
                <View data-layer="40fe2f4e-249b-4625-b557-2efd79be2fbb" style={styles.modalachat_modal_restaurerachats_ville66b938f6}>
                    <Text data-layer="50a918c5-682e-4926-89f1-7d46c9dd2a62" style={styles.modalachat_modal_restaurerachats_ville66b938f6_versailles6ac1c7c8}>Restaurer Achats</Text>
                </View>
            </View>
...
Modalachat.propTypes = {

}

Modalachat.defaultProps = {
