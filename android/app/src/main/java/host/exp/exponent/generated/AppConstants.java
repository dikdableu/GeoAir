...
public class AppConstants {
  ...
  public static String INITIAL_URL = "exp://exp.host/@dikdableu/GeoAir";
  public static final String SHELL_APP_SCHEME = "geoair";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
      ...
      embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@dikdableu/GeoAir", "assets://shell-app-manifest.json", "application/json"));
      embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40dikdableu%2FGeoAir%2F1.0.43%2Fa2541c0d0633ca7c33070697c8b1631b-36.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
