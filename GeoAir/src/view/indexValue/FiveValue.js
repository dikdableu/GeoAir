...
export default class FiveValue extends React.Component {
  render(){
    ...
    return(
      ...
      <CardItem header style={{shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 3.84, elevation: 5}}>
        <View style={{ borderWidth: 1, borderRadius: 50, padding: '5%', borderColor: '#8900E8', backgroundColor: '#8900E8', marginRight: '6%', shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 3.84, elevation: 5}}>
