...
export default class ThreeValue extends React.Component {
  render(){
    ...
    return(
      ...
      <CardItem header style={{shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 3.84, elevation: 5}}>
        <View style={{ borderWidth: 1, borderRadius: 50, padding: '5%', borderColor: '#ECA100', backgroundColor: '#ECA100', marginRight: '6%', shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 3.84, elevation: 5}}>
