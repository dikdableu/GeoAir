...
export default class FourValue extends React.Component {
  render(){
    ...
    return(
      ...
      <CardItem header style={{shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 3.84, elevation: 5}}>
        <View style={{ borderWidth: 1, borderRadius: 50, padding: '5%', borderColor: '#F94B1C', backgroundColor: '#F94B1C', marginRight: '6%', shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 3.84, elevation: 5}}>
